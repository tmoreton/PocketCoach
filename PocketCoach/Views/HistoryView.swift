                        ...
                        HStack {
                            Button(action: {
                                ...
                                Text(isSelectionMode ? "Done" : "Select")
                                    ...
                                    .foregroundColor(isSelectionMode ? Constants.coachingPrimaryColor : .secondary)
    ...
    var body: some View {
        Button(action: action) {
            Text(title)
                ...
                .padding(.vertical, 8)
                .background(isSelected ? Constants.coachingPrimaryColor : Color.secondary.opacity(0.05))
        ...
        HStack(alignment: .top, spacing: 12) {
            if isSelectionMode {
                Button(action: onTap) {
                    Image(systemName: isSelected ? "checkmark.circle.fill" : "circle")
                        .foregroundColor(isSelected ? Constants.coachingPrimaryColor : .secondary.opacity(0.3))
                        .font(.system(size: 20))
                }
                .buttonStyle(PlainButtonStyle())
                .padding(.top, 12)
            ...
            ZStack(alignment: .trailing) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    .foregroundColor(Constants.coachingCardForeground.opacity(0.6))
