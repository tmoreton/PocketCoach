        ...
        HStack(spacing: 4) {
            ForEach(0..<5) { index in
                RoundedRectangle(cornerRadius: 2)
                    .fill(Constants.therapyPrimaryColor)
...
struct AnimatedRecordingButton: View {
    ...
    var body: some View {
        ZStack {
            // Ripple effect
            Circle()
                .stroke(isRecording ? Color.red : Constants.therapyPrimaryColor, lineWidth: 2)
    ...
    private var buttonBackgroundColor: Color {
        if isDisabled {
            ...
            return Constants.therapyPrimaryColor
        }
    }
    ...
    private var buttonShadowColor: Color {
        if isDisabled {
            ...
            return Constants.therapyPrimaryColor.opacity(0.3)
        }
    }
